...
<div class="wrap">
	...
	<form class="sc-edit-short-code" method="post" action="">
		...
		<div>各パラメータの詳しい説明は&ensp;<a href="https://www.zazzle.com/sell/affiliates/promotionaltools/rss" target="_blank">RSS feeds (Zazzle公式ページ・英語ページのみ)</a>&ensp;をご確認ください。</div>
				...
				<table class="form-table">
					...
					<tr>
						...
						<td><input name="title" type="text" id="title" required
								value="<?php if($updateFlg){echo $feedSetting->title;} ?>"
    ...
    ?>>マーケットプレイス</option>
					...
					<tr id="hideMarket">
						...
						<td><input name="feed_name" type="text" id="feedName"
								value="<?php if($updateFlg){echo $feedSetting->feed_name;} ?>"
								class="regular-text" /></td>
					</tr>
					<tr>
				...
				<table class="form-table">
					<tr>
						...
						<td><input name="phrase" type="text" id="phrase"
								value="<?php if($updateFlg){echo $feedSetting->phrase;} ?>"
								class="regular-text" /></td>
					</tr>
					<tr>
						...
						<td><input name="department" type="text" id="department"
								value="<?php if($updateFlg){echo $feedSetting->department;} ?>"
								class="regular-text" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="affiliate_code" type="text" id="affiliateCode"
								value="<?php if($updateFlg){echo $feedSetting->affiliate_code;} ?>"
								class="regular-text" /></td>
					</tr>
					<tr>
						<th scope="row"><label for="trackingCode">トラッキングコード</label></th>
						<td><input name="tracking_code" type="text" id="trackingCode"
								value="<?php if($updateFlg){echo $feedSetting->tracking_code;} ?>"
								class="regular-text" /></td>
					</tr>
					<?php } ?>
				</table>
			...
			<input type="hidden" name="update_date"
				value="<?php if($updateFlg){echo $feedSetting->update_date;} ?>">
			<input type="hidden" name="scid"
				value="<?php if($updateFlg){echo $feedSetting->scid;} ?>">
